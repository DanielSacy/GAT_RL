...
instances_config = [
    {'n_customers': 10, 'max_demand': 200, 'max_distance': 100, 'num_instances': 100}
...
filename = r'D:\DAY2DAY\MESTRADO\Codes\GNN\GAT_VRP1\gat_vrp1\src_batch\instance_creator\instance_data_100.csv'
